...
PROTOCOL_PACKAGE = getattr(settings, "PROTOCOL_PACKAGE", 'titulus_ws')

PROTOCOL_CLASS = getattr(settings, "PROTOCOL_CLASS", f'{PROTOCOL_PACKAGE}.protocollo')
...
FASCICOLAZIONE_SEPARATA = getattr(settings, "FASCICOLAZIONE_SEPARATA", True)

PATH_ROOT = getattr(settings, "PATH_ROOT", 'titulus_ws')
PATH_XML_TEMPLATES = getattr(settings, "PATH_XML_TEMPLATES", f'{BASE_ROOT}/xml_templates')

DOCUMENTO_ENTRATA_XML = getattr(settings, "DOCUMENTO_ENTRATA_XML", "documento_entrata.xml")
FASCICOLO_XML = getattr(settings, "FASCICOLO_XML", "fascicolo.xml")

DOCUMENTO_ENTRATA_PATH = getattr(settings, "DOCUMENTO_ENTRATA_PATH", f'{PATH_XML_TEMPLATES}/{DOCUMENTO_ENTRATA_XML}')
FASCICOLO_PATH = getattr(settings, "FASCICOLO_PATH", f'{PATH_XML_TEMPLATES}/{FASCICOLO_XML}')

# TEST CREDENTIALS
PROTOCOL_TEST_LOGIN = getattr(settings, "PROTOCOL_TEST_LOGIN", 'TEST_LOGIN')
PROTOCOL_TEST_PASSW = getattr(settings, "PROTOCOL_TEST_PASSW", 'TEST_PASSWORD')

# XML flusso Titulus
PROTOCOL_XML = getattr(settings, "PROTOCOL_PACKAGE", """
...
TITOLARIO_DICT = getattr(settings, "TITOLARIO_DICT", (
    ("Amministrazione",
        (
...
UO_DICT = getattr(settings, "UO_DICT", (
